...
Для краткости подготовка массивов \texttt{x}/\texttt{y}, символов
\texttt{x\_symbol}/\texttt{param\_symbols}, функции \texttt{wrapped\_formula},
а также начальные параметры \texttt{p0} и границы \texttt{lower}/\texttt{upper}
в примере ниже опущены.
\begin{codeblock}
